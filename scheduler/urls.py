...
urlpatterns = patterns('',
    url(r'^(?P<caseid>[0-9a-zA-Z]+)/(?P<term>$[FUS][0-9]{4})$', 'course_scheduler.views.schedule', name='base'),
    url(r'^(?P<caseid>[0-9a-zA-Z]+)$', 'course_scheduler.views.schedule', name='base_no_term'),
    url(r'^$', 'course_scheduler.views.schedule', name='base_no_data'),
    url(r'^scheduler/add/$', 'course_scheduler.views.add', name='add'),
    url(r'^scheduler/info$', 'course_scheduler.views.info', name='info'),
    url(r'^scheduler/info/(?P<term>$[FUS][0-9]{4})$', 'course_scheduler.views.info', name='info'),
    ...
    url(r'^scheduler/inscourse/(?P<term>$[FUS][0-9]{4})$', 'course_scheduler.views.inscourse', name='inscourse'),
    ...
    url(r'^scheduler/mycourses/(?P<term>$[FUS][0-9]{4})$', 'course_scheduler.views.mycourses', name='mycourses'),
    url(r'^scheduler/customevent$', 'course_scheduler.views.customevent', name='customevent'),
    url(r'^scheduler/customevent/(?P<term>$[FUS][0-9]{4})$', 'course_scheduler.views.customevent', name='customevent'),
    ...
    url(r'^scheduler/event_json/(?P<caseid>[0-9a-zA-Z]+)/(?P<term>$[FUS][0-9]{4})$', 'course_scheduler.views.event_json', name='event_json'),
