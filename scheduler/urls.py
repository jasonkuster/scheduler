...
urlpatterns = patterns('',
    ...
    url(r'^scheduler/add_course/$', 'course_scheduler.views.add_course', name='add_course'),
    url(r'^scheduler/remove_course/$', 'course_scheduler.views.remove_course', name='remove_course'),
)
